...
`,c=s.Ay.li`
  ...
  ${e=>e.selected&&"\n    background-color: lightgray;\n  "}
`;var l=r(579);const p=e=>{let{onSelect:t,onSelectAll:r,selectedPahrmacy:n}=e;const[s,p]=(0,i.useState)([]);return(0,i.useEffect)((()=>{(async()=>{try{const e=await a();p(e)}catch(e){console.log("Error getting pharmacies list",e)}})()}),[]),(0,l.jsxs)(o,{children:[(0,l.jsx)(d,{children:"Pharmacies:"}),(0,l.jsxs)("ul",{children:[(0,l.jsx)(c,{onClick:()=>r(),selected:null===n,children:(0,l.jsx)("p",{children:"All pharmacies"})},1),s&&s.map((e=>(0,l.jsx)(c,{onClick:()=>t(e._id),selected:n===e._id,children:(0,l.jsx)("p",{children:e.name})},e._id)))]})]})},h=s.Ay.ul`
  border: 1px solid #333;
  border-radius: 10px;
  padding: 15px;
  /* display: flex;
...
`;var b=r(686);const v=e=>{let{drugsList:t,changeFavorite:r}=e;const[n,a]=(0,i.useState)((()=>JSON.parse(localStorage.getItem("medicineCart"))||[]));(0,i.useEffect)((()=>{localStorage.setItem("medicineCart",JSON.stringify(n))}),[n]);return(0,l.jsx)(h,{children:t.length>0&&t.map((e=>(0,l.jsxs)(g,{children:[(0,l.jsx)(u,{children:(0,l.jsx)("img",{src:e.photo,alt:e.name,width:"200",height:"200"})}),(0,l.jsx)(x,{children:e.name}),(0,l.jsxs)(y,{children:[(0,l.jsxs)("p",{children:["Price: ",e.price," \u20b4"]}),(0,l.jsx)(m,{type:"button",onClick:()=>(e=>{const t={...e,quantity:1},r=n.find((t=>t.name===e.name&&t.pharmacy===e.pharmacy));"undefined"!==typeof r?(r.quantity+=1,a([...n])):a((e=>[...e,t]))})(e),children:"Add to cart"}),(0,l.jsx)(f,{onClick:()=>r(e),favorite:e.favorite.toString(),children:(0,l.jsx)(b.MUx,{})})]})]},e._id)))})},j=async function(e){let t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:"",r=arguments.length>2&&void 0!==arguments[2]?arguments[2]:"";const i={};""!==t&&(i.date=t),""!==r&&(i.price=r);const{data:a}=await n.A.get(`/api/drugs/${e}`,{params:i});return a},w=async function(){let e=arguments.length>0&&void 0!==arguments[0]?arguments[0]:"",t=arguments.length>1&&void 0!==arguments[1]?arguments[1]:"";const r={};""!==e&&(r.date=e),""!==t&&(r.price=t);const{data:i}=await n.A.get("/api/drugs",{params:r});return i},A=async(e,t)=>{const{data:r}=await n.A.patch(`/api/drugs/${e}/favorite`,{favorite:t});return r},k=s.Ay.div`
  display: flex;
  gap: 10px;
  flex-direction: column;
  @media screen and (min-width: 768px) {
